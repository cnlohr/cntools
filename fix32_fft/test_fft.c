...
int main()
{
	...
	for( i = 0; i < 4096; i++ )
	{
		real[i] = sin( i ) * ((1LL<<18)-1); //(rand()%10001)-5000;
		imag[i] = cos( i ) * ((1LL<<18)-1); //(rand()%10001)-5000;
	}

	if( fix32_fft( real, imag, M, 0, 0 ) ) goto fail;
//	fix32_shift( real, imag, M, 6 );
	if( fix32_fft( real, imag, M, 1, 1 ) ) goto fail;
//	fix32_shift( real, imag, M, -12 );
	...
	for( i = 0; i < 4096; i++ )
	{
		int rcheck = sin( i ) * ((1LL<<18)-1); //(rand()%10001)-5000;
		int icheck = cos( i ) * ((1LL<<18)-1); //(rand()%10001)-5000;
		//if( i < 50 ) printf( "%d  %d\n", rcheck, real[i] );
		total_deviation +=
