...
int main()
{
	...
	ta = (ta & 0xCCCC3333) | (((ta>>14) & 0x0000CCCC)) | ((ta & 0x0000CCCC) << 14);
	tb = (tb & 0xCCCC3333) | (((tb>>14) & 0x0000CCCC)) | ((tb & 0x0000CCCC) << 14);
	...
	ta = (ta & 0x3333CCCC) | (((ta>>18) & 0x00003333)) | ((ta & 0x00003333) << 18);
	tb = (tb & 0x3333CCCC) | (((tb>>18) & 0x00003333)) | ((tb & 0x00003333) << 18);
